/**
 * dseam-skillmcp mcp —— MCP 服务器管理子命令。
 *
...
function usage() {
    console.log([
        ...
        "  dseam-skillmcp mcp add --name <serverName> --stdio --command <cmd> [--args <arg> ...] [--env KEY=VALUE ...] [--cwd <path>]",
        "  dseam-skillmcp mcp add --name <serverName> --http --url <url> [--header KEY=VALUE ...]",
        "  dseam-skillmcp mcp remove <serverName> [--yes] [--profile <name>]",
        "  dseam-skillmcp mcp enable <serverName> [--profile <name>]",
        "  dseam-skillmcp mcp disable <serverName> [--profile <name>]",
