window.__ModuleLoader__.load({
    ...
    factory: (require) => {
        ...
        // 束契约：本文件由宿主以 /plugins/dseam-skillmcp/client.js 提供，
        ...
        const tagId = "dseam-skillmcp/SkillsSection.module.css";
        if (typeof document !== "undefined") {
            let tag = document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]");
            if (tag === null) {
                tag = document.createElement("style");
                tag.dataset.plugin = "dseam-skillmcp";
        ...
        const zh = {
            ...
            checkUpdateHint: "）。可在终端运行 dseam-skillmcp update 更新"
        };
        const en = {
            nav: "Skills",
            ...
            checkUpdateHint: "). Run dseam-skillmcp update in a terminal to install it"
        };
        // ── 远程贡献 ─────────────────────────────────────────────────────────
            ...
            descriptors: [
                {
                    ...
                    parameters: [
                        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dseam-skillmcp#sessionId") }
                    ],
                    result: codec("dseam-skillmcp#SkillListResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [],
                    result: codec("dseam-skillmcp#WorkspacesResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [],
                    result: codec("dseam-skillmcp#GroupsResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [],
                    result: codec("dseam-skillmcp#CheckUpdateResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#SaveGroupPayload") }
                    ],
                    result: codec("dseam-skillmcp#GroupsResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#DeleteGroupPayload") }
                    ],
                    result: codec("dseam-skillmcp#GroupsResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [
                        { name: "name", wire: "name", source: "json", codec: codec("dseam-skillmcp#SkillName") },
                        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dseam-skillmcp#sessionId") },
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#MigratePayload") }
                    ],
                    result: codec("dseam-skillmcp#MigrateResult")
                },
                {
                    ...
                    parameters: [
                        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dseam-skillmcp#sessionId") },
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#BatchMigratePayload") }
                    ],
                    result: codec("dseam-skillmcp#BatchMigrateResult")
                },
                {
                    ...
                    parameters: [
                        { name: "name", wire: "name", source: "json", codec: codec("dseam-skillmcp#SkillName") },
                        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dseam-skillmcp#sessionId") },
                        { name: "scope", wire: "scope", source: "json", acceptsUndefined: true, codec: codec("dseam-skillmcp#SkillScope") }
                    ],
                    result: codec("dseam-skillmcp#SkillContent")
                },
                {
                    ...
                    parameters: [
                        { name: "name", wire: "name", source: "json", codec: codec("dseam-skillmcp#SkillName") },
                        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dseam-skillmcp#sessionId") },
                        { name: "enabled", wire: "enabled", source: "json", codec: codec("dseam-skillmcp#EnabledFlag") },
                        { name: "scope", wire: "scope", source: "json", acceptsUndefined: true, codec: codec("dseam-skillmcp#SkillScope") }
                    ],
                    result: codec("dseam-skillmcp#SetEnabledResult")
                },
                {
                    ...
                    result: codec("dseam-skillmcp#DeleteSkillResult")
                },
                {
                    ...
                    parameters: [
                        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dseam-skillmcp#sessionId") },
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#AddPayload") }
                    ],
                    result: codec("dseam-skillmcp#AddResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [],
                    result: codec("dseam-skillmcp#McpListResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#McpSavePayload") }
                    ],
                    result: codec("dseam-skillmcp#McpSaveResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#McpRemovePayload") }
                    ],
                    result: codec("dseam-skillmcp#McpRemoveResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#McpSetEnabledPayload") }
                    ],
                    result: codec("dseam-skillmcp#McpSaveResult")
                },
                {
                    ...
                    invocation: { kind: "direct" },
                    parameters: [
                        { name: "payload", wire: "payload", source: "json", codec: codec("dseam-skillmcp#McpTestPayload") }
                    ],
                    result: codec("dseam-skillmcp#McpTestResult")
                },
                {
