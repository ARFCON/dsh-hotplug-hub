 ...
 * 变化，因此以上所有操作都无需重启。
 */
export const name = "dseam-skillmcp";
...
const MANIFEST = {
    ...
    invocations: [
        {
            id: "dseam-skillmcp#skillsViewer/list",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "list",
            invocation: { kind: "direct" },
            parameters: [
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dseam-skillmcp#sessionId", schema: sessionIdSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#SkillListResult", schema: listResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/workspaces",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "workspaces",
            invocation: { kind: "direct" },
            parameters: [],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#WorkspacesResult", schema: workspacesResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/groups",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "groups",
            invocation: { kind: "direct" },
            parameters: [],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#GroupsResult", schema: groupsResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/checkUpdate",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "checkUpdate",
            invocation: { kind: "direct" },
            parameters: [],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#CheckUpdateResult", schema: checkUpdateResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/saveGroup",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "saveGroup",
            invocation: { kind: "direct" },
            parameters: [
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#SaveGroupPayload", schema: saveGroupPayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#GroupsResult", schema: groupsResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/deleteGroup",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "deleteGroup",
            invocation: { kind: "direct" },
            parameters: [
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#DeleteGroupPayload", schema: deleteGroupPayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#GroupsResult", schema: groupsResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/content",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "content",
            invocation: { kind: "direct" },
            parameters: [
                { name: "name", wire: "name", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#SkillName", schema: z.string() } },
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dseam-skillmcp#sessionId", schema: sessionIdSchema } },
                { name: "scope", wire: "scope", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dseam-skillmcp#SkillScope", schema: z.union([z.string(), z.null()]) } }
            ],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#SkillContent", schema: skillContentSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/setEnabled",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "setEnabled",
            invocation: { kind: "direct" },
            parameters: [
                { name: "name", wire: "name", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#SkillName", schema: z.string() } },
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dseam-skillmcp#sessionId", schema: sessionIdSchema } },
                { name: "enabled", wire: "enabled", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#EnabledFlag", schema: z.boolean() } },
                { name: "scope", wire: "scope", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dseam-skillmcp#SkillScope", schema: z.union([z.string(), z.null()]) } }
            ],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#SetEnabledResult", schema: setEnabledResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/migrate",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "migrate",
            invocation: { kind: "direct" },
            parameters: [
                { name: "name", wire: "name", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#SkillName", schema: z.string() } },
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dseam-skillmcp#sessionId", schema: sessionIdSchema } },
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#MigratePayload", schema: migratePayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#MigrateResult", schema: migrateResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/batchMigrate",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "batchMigrate",
            invocation: { kind: "direct" },
            parameters: [
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dseam-skillmcp#sessionId", schema: sessionIdSchema } },
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#BatchMigratePayload", schema: batchMigratePayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#BatchMigrateResult", schema: batchMigrateResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/deleteSkill",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "deleteSkill",
            invocation: { kind: "direct" },
            ...
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#DeleteSkillResult", schema: deleteSkillResultSchema }
        },
        {
            id: "dseam-skillmcp#skillsViewer/addSkill",
            service: "skillsViewer",
            namespace: "skillsViewer",
            method: "addSkill",
            invocation: { kind: "direct" },
            parameters: [
                { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dseam-skillmcp#sessionId", schema: sessionIdSchema } },
                { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dseam-skillmcp#AddPayload", schema: addPayloadSchema } }
            ],
            result: { mode: "strict", typeSymbol: "dseam-skillmcp#AddResult", schema: addResultSchema }
        }
    ],
...
export function apply(ctx) {
    ...
    ctx.effect(() => ctx.typert.register(PANEL_MANIFEST), "dseam-skillmcp: typert manifest");
}
